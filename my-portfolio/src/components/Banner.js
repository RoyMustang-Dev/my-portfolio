...
export const Banner = () => {
  ...
  const toRotate = [ "Data Analyst", "Data Scientist", "Machine Learning Engineer" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Aditya `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Data Analyst", "Data Scientist", "Machine Learning Engineer" ]'><span className="wrap">{text}</span></span></h1>
